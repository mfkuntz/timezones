defmodule Timezones.Util do
  ...
  def data_dir do
    case Application.fetch_env(:timezones, :data_dir) do
      {:ok, nil} -> Application.app_dir(:timezones, "priv")
      {:ok, dir} -> dir
      _ -> Application.app_dir(:timezones, "priv")
    end
  end
