defmodule UtilTest do
  ...
  alias Timezones.Util, as: TzUtil
  alias Timezones.BasicDataMap
  import TzUtil
  doctest Timezones.Util
  ...
  test "rules that apply for a certain year" do
    {:ok, map} = BasicDataMap.from_files_in_dir("test/timezones_fixtures/source_data")
