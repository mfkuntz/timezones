defmodule Timezones.PeriodBuilderTest do
  use ExUnit.Case, async: true
  import Timezones.PeriodBuilder

  @fixtures_dir "test/timezones_fixtures/"
  ...
  setup_all do
    {:ok, map} = Timezones.BasicDataMap.from_files_in_dir(@source_data_dir)
    {:ok, %{map: map}}
  end
  ...
  describe "special case time zones with overlap" do
    setup do
      {:ok, map} = Timezones.BasicDataMap.from_single_file_in_dir(@fixtures_dir, "rule_overlap")
      {:ok, %{map: map}}
    end
