defmodule TzParserOrganizerTest do
  ...
  alias Timezones.Parser, as: TzParser
  alias Timezones.ParserOrganizer, as: Organizer
  @source_data_dir "test/timezones_fixtures/source_data"

  test "Zone map" do
    europe = TzParser.read_file("europe_shortened", "test/timezones_fixtures")
